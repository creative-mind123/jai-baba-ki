...
export async function generateMetadata(
  ...
  return {
    title: `At-Home Physiotherapy in ${subLocation.name}, Delhi | WellnessHub`,
    description: `Get expert doctor visits and at-home physiotherapy in ${subLocation.name}. We offer a range of wellness services to residents of ${subLocation.name}, Delhi. Book your session today.`,
  }
}
