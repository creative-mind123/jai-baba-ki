...
export async function generateMetadata(
  ...
  return {
    title: `Doctor Visit at Home in ${subLocation.name}, Gurgaon | WellnessHub`,
    description: `Get expert doctor visits and at-home wellness services in ${subLocation.name}. We offer physiotherapy, yoga, and more to residents of ${subLocation.name}, Gurgaon. Book your session today.`,
  }
}
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
               ...
               <div className="relative h-64 md:h-80 rounded-lg overflow-hidden shadow-lg">
                <Image
                  src={gurgaonData.image.src.replace(/ /g, '%20')}
                  alt={`At-home wellness services in ${subLocation.name}, Gurgaon`}
