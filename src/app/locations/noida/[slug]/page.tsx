...
export async function generateMetadata(
  ...
  return {
    title: `#1 At-Home Physiotherapy in ${subLocation.name}, Noida | ICBR`,
    description: `Get top-ranked doctor visits and #1 at-home physiotherapy in ${subLocation.name}. We offer the best wellness services for residents of ${subLocation.name}, Noida. Book your session today.`,
  }
}
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-muted-foreground">
                    Get top-ranked, professional, compassionate care from #1 certified practitioners in {subLocation.name}. We bring the best wellness services, including physiotherapy and expert consultations, right to your doorstep.
                </p>
               ...
               <div className="relative h-64 md:h-80 rounded-lg overflow-hidden shadow-lg">
                <Image
                  src={noidaData.image.src.replace(/ /g, '%20')}
                  alt={`#1 at-home wellness services in ${subLocation.name}, Noida`}
         ...
         <section className="py-16 lg:py-24 text-center bg-background">
            <div className="container">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                   Ready to experience the best at-home wellness care in Noida? Book your appointment in {subLocation.name} today and let our #1 certified experts come to you.
                </p>
